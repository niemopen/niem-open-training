...
NIEMOpen is an OASIS Open Project and welcomes participation by anyone, whether affiliated with OASIS or not. Substantive contributions and feedback are invited from all parties, following the common conventions for participation in GitHub public repository projects.
...
Longer discussions can be taken up on the GitHub Discussions list or via the [mailing list](https://lists.oasis-open-projects.org/g/niemopen/messages). 
